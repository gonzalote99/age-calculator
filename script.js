...
sub_heading.innerHTML = 'get age';
cal.innerHTML = 'calculate';

github.innerHTML = 'contribute';


$(document).ready(function() {
  $('.hidden-section').css('display', 'flex');
  $('.hidden-section').slideUp(1);
});
...
cal.addEventListener('click', () => {
  ...
  if(dob.value == "") {
    ...
    cal.style.color = 'red';
    cal.innerHTML = 'select date';
    $('.hidden_section').slideUp(250);
    $('.heading_section').slideDown(250);
    sub_heading.innerHTML = 'select date';
    ...
    cal.style.color = 'red';
    cal.innerHTML = 'incorrect date';
    sub_heading.innerHTML = 'incorrect date';
    sub_heading.style.color = 'red';
    $('.hidden_section').slideUp(250);
    $('.heading_section').slideDown(250);
    ...
    const animation = setInterval(() => {
      ...
      day_span.innerHTML = Math.floor(Math.random() * 100000);
      hour_span.innerHTML = Math.floor(Math.random() * 1000000);
      min_span.innerHTML = Math.floor(Math.random() * 10000000);
      sec_span.innerHTML = Math.floor(Math.random() * 100000000);
    }, 1);
